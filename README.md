...
```bash
# 1. Clone & install
git clone https://github.com/sapnabalaji306-netizen/webcmd-hackathon-studenthub.git
...
All modules communicate via JSON files in `data/`. See `IMPLEMENTATION_PLAN.md` for full schemas.
