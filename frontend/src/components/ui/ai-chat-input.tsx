...
function ModelIcon({ model, className }: { model: string; className?: string }) {
  const icons: Record<string, string> = {
    "Groq LPU": "https://res.cloudinary.com/drhx7imeb/image/upload/v1781695268/google-gemini-icon_l6kk5q.svg",
    "Atlas DeepSeek": "https://res.cloudinary.com/drhx7imeb/image/upload/v1781695268/cursor-ai-code-icon_j4vnux.svg",
  ...
  return (
    <img 
      src={icons[model] || icons["Groq LPU"]} 
      alt={model} 
  ...
  (
    {
      ...
      className,
      models = ["Groq LPU", "Atlas DeepSeek", "GPT 5.5"],
    ...
    const startRecording = useCallback(async () => {
      ...
      function simulateText() {
        const fakeText = "Can you analyze my BTech attendance risk and suggest high-stipend internships?";
